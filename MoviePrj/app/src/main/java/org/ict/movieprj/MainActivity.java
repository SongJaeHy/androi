...
import org.ict.movieprj.retrofit.RecycleAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    // 상수로 본인 key값을 저장합니다.
    final String KEY = "d863c0c615496b652aba0c5a92bb7fb3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retrofitInterface.getBoxOffice(KEY, "20211101").enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                ...
                // result 내부의 영화정보를 얻어서 RecycleAdapter 생성자에 전달
                rAdapter = new RecycleAdapter(result.getBoxOfficeResult().getDailyBoxOfficeList());
